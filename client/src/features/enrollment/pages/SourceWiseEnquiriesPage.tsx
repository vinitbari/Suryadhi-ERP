      ...
      >
        <div className="flex items-center gap-3">
          ...
          <Button variant="outline" size="sm" onClick={() => downloadAsPDF({
            title: 'Source Wise Enquiries Report',
            subtitle: `Academic Year: ${academicYear === 'ay1' ? 'Apr 26 - Mar 27' : 'Apr 25 - Mar 26'}`,
            columns: ['Program', 'Walk-in', 'Gate App', 'Digital', 'BVN', 'Total'],
            rows: data.map((r: any) => [r.program, r.walkin ?? 0, r.gateApp ?? 0, r.digital ?? 0, r.bvn ?? 0, r.total ?? 0]),
            filename: 'source-wise-enquiries',
          })}>
